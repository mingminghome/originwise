...
export const en: MessageTree = {
  ...
  check: {
    ...
    altDisclaimer:
      'Aimed at substitutes not made in mainland China, or with lower China involvement than the item you checked — not merely “similar” peers. Estimates only; a US/EU HQ does not guarantee non-China manufacture. Unclear made-in is marked Unknown, not Unrelated.',
    estimated: 'est.',
